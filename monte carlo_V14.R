...
rm(list = ls())
setwd("~/Desktop/PA 881/Project code")
...
projections_base <- read.csv("Energy_Prices_Residential_projections.csv", 
...
temperature_bin_hours <- read.csv("temperature bins.csv", stringsAsFactors = F)
